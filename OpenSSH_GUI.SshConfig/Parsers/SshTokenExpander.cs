...
namespace OpenSSH_GUI.SshConfig.Parsers;
...
/// <param name="HostKeyAlias">
///     The host-key alias if set via <c>HostKeyAlias</c>, otherwise <see langword="null" /> (
///     <c>%k</c>).
/// </param>
/// <param name="ConnectionHash">SHA-1 hash of <c>%l%h%p%r%u</c> for use in <c>ControlPath</c> (<c>%C</c>).</param>
/// <param name="ProxySocketPath">
///     The proxy socket path when using <c>ProxyUseFdpass</c> (<c>%T</c>), or
///     <see langword="null" />.
/// </param>
