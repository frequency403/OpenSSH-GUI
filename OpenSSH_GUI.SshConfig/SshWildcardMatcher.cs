...
///   <item><description><c>!</c> prefix — negates the pattern; a negated match always takes priority.</description></item>
/// </list>
/// </remarks>
public static class SshWildcardMatcher
{
    ...
    /// <list type="number">
    ///   <item><description>At least one non-negated pattern matches, <b>and</b></description></item>
    ///   <item><description>No negated (<c>!</c>-prefixed) pattern matches.</description></item>
    /// </list>
