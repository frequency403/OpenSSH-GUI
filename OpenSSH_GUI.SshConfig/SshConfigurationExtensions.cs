...
public static class SshConfigurationExtensions
{
    ...
    /// <param name="reloadOnChange">Whether the configuration should be reloaded if the file changes.</param>
    /// <returns>The <see cref="IConfigurationBuilder" />.</returns>
    public static IConfigurationBuilder AddSshConfig(this IConfigurationBuilder builder, IFileProvider? fileProvider,
    ...
    /// <returns>The <see cref="IConfigurationBuilder" />.</returns>
    public static IConfigurationBuilder AddSshConfig(this IConfigurationBuilder builder,
        Action<SshConfigurationSource>? configureSource)
    {
