...
public record KeyManagerOperationResult
{
    ...
    public static KeyManagerOperationResult Success() => new() { Result = OperationResult.Success };
    ...
    public static KeyManagerOperationResult Failure(Exception exception) => new() { Result = OperationResult.Failure, Exception = exception };
    public static KeyManagerOperationResult Conflict(Exception exception) => new() { Result = OperationResult.Conflict, Exception = exception };
    internal static KeyManagerOperationResult Cancelled(Exception exception) => new() { Result = OperationResult.Cancelled, Exception = exception };
...
#pragma warning restore CS8776
    ...
    public static KeyManagerOperationResult<T> Success(T value) => new() { Result = OperationResult.Success, ResultValue = value };
}