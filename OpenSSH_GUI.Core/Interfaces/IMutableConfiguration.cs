...
public interface IMutableConfiguration<T> : IDisposable where T : class
{
    ...
    /// </summary>
    /// <remarks>
    ///     This property provides access to the current state of the configuration as managed by the underlying options
    ///     mechanism.
    ...
    ///     This can be particularly useful for scenarios where live updates to settings or parameters require immediate
    ///     processing.
    /// </remarks>
