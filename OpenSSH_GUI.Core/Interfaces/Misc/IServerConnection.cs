...
public interface IServerConnection : IReactiveObject, IDisposable
{
    ...
    /// </summary>
    /// <param name="exception">An <see cref="Exception"/> that represents the error that occurred during the test and open connection process, if any. If the test and open connection process is successful, this value is <c>null</c>.</param>
