...
/// </summary>
public interface IServerConnectionService : IReactiveNotifyPropertyChanged<IReactiveObject>, IHandleObservableErrors,
    IReactiveObject
{
    /// <summary>
    ...
    /// </returns>
    ValueTask<bool> EstablishConnection(IConnectionCredentials connectionCredentials,
