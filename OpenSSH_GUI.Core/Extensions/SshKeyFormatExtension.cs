...
public static class SshKeyFormatExtension
{
    ...
    /// <returns>The file extension associated with the specified SSH key format. Returns null if the format is not supported or the extension is not applicable.</returns>
