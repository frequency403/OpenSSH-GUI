...
public static class DependencyInjectionExtensions
{
    ...
    {
        return RequiredPropertiesCache.GetOrAdd(
            type, static t =>
    ...
    private static bool ValidateNamingConvention<T1, T2>()
    {
        ...
        var option1 = string.Equals(
            t1Name.Replace("Window", string.Empty), t2Name.Replace("ViewModel", string.Empty),
    ...
    extension(IHostBuilder builder)
    {
        ...
        public IHostBuilder AddMutableConfiguration<T>(string filePath, JsonTypeInfo<T> typeInfo, bool optionalFile = true, string? sectionName = null) where T : class
            ...
            {
                configurationBuilder.AddJsonFile(filePath, optionalFile, true);
            });
    }
    ...
    extension(IServiceCollection services)
    {
            ...
            where TView : Window
        {
            ...
            var serviceDescriptorView = ServiceDescriptor.DescribeKeyed(
                viewType, viewType.Name, (provider, _) =>
                {
