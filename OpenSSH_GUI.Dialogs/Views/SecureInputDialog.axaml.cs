...
/// <list type="bullet">
///   <item>Intercepts <see cref="TextBox.TextInputEvent"/> at tunnel phase,
///         marking the event handled so the default string accumulation is
///         suppressed.</item>
///   <item>Maintains its own <see cref="List{T}"/> of raw UTF-8 byte segments,
///         assembled per typed character.</item>
///   <item>Handles <see cref="Key.Back"/> and <see cref="Key.Delete"/> to
///         remove the last encoded character from the buffer.</item>
/// </list>
